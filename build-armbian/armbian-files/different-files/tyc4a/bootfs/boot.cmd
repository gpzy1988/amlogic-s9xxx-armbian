...
if test -e ${devtype} ${devnum} ${prefix}zImage; then
	...
	if test "${console}" = "serial"; then setenv consoleargs "console=ttyFIQ0,1500000"; fi
	if test "${console}" = "display" || test "${console}" = "both"; then setenv consoleargs "console=ttyFIQ0,1500000 console=tty1"; fi
	if test "${console}" = "serial"; then setenv consoleargs "console=ttyFIQ0,1500000"; fi
	if test "${bootlogo}" = "true"; then
		setenv consoleargs "splash plymouth.ignore-serial-consoles ${consoleargs}"
	else
